        ...
        <div className="z-10 absolute bg-base-200 w-[400px] p-5 font-[600] rounded-[10px] drop-shadow-lg ">
          <div>
            <div className="flex gap-[25%] text-end w-full justify-end pb-5 items-center">
              ...
              <button className="rounded-[50%] bg-[#ffffff36] p-2 hover:bg-[#fff]">
                <img
                  className="w-3"
    ...
    backgroundPositionX: "center",}
            ...
            <div className="mt-5">
              ...
              <div className="flex justify-between ">
                <button onClick={()=>{setBg_images("https://avatars.mds.yandex.net/i?id=4f7586d49edaa427e07a8819562fc284_l-5248434-images-thumbs&n=13")}} className="w-[24%]">
                  <img
                ...
                <button onClick={()=>{setBg_images()}} className="w-[24%]">
                  <img
                    className="w-full h-14 rounded-[5px]"
              ...
              <div className="mt-2 flex justify-between">
                <button onClick={()=>{setBg_images("#000")}} className="bg-[#000] w-[55px] h-[40px] rounded-[5px]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#04f6b9] w-[55px] h-[40px] rounded-[5px]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#2cf405] w-[55px] h-[40px] rounded-[5px]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#f60202] w-[55px] h-[40px] rounded-[5px]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#0b03f5] w-[55px] h-[40px] rounded-[5px]"></button>
                <button
                  onClick={() => {
                    color();
                  }}
                      ...
                      >
                        ...
                        <div className="w-[80%]">
                          ...
                          <p>
                            ...
                            elit. Veniam, repudiandae! Necessitatibus ea
                            explicabo ullam ab veniam earum, perspiciatis
                            perferendis ducimus?
                          </p>
                        </div>
                      </div>
          ...
          <div className="bg-base-200 drop-shadow-lg w-[400px] p-5 rounded-[10px]  absolute z-30 top-20 left-[420px] ">
            ...
            <div className="relative">
              ...
              <div>
               ...
               {images&& <div className="absolute  w-[410px] bottom-[-280px] bg-base-200 p-5 left-0 drop-shadow-lg rounded-[10px] z-10"
                >
                  <div className="flex justify-between items-center py-2">
                    <p className="text-[20px] font-[600]">Ranglar</p>
                  </div>
                  <div className="div-1 pt-2">
                    <button onClick={()=>{setBg_images()}} className="bg-[#000]">
                      <img
                    ...
                    <button onClick={()=>{setBg_images()}} className="bg-[#000]">
                      <img src="https://i.redd.it/y5fk4e5lcuuz.jpg" alt="" />
                    </button>
                    <button onClick={()=>{setBg_images()}} className="bg-[#000]">
                      <img
            ...
            <div className="relative w-[100%]">
              ...
              <div className="div-1">
                <button onClick={()=>{setBg_images()}} className="bg-[#0b048f]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#f10606]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#f09409]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#e806c6]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#2ff009]"></button>
                <button onClick={()=>{setBg_images()}} className="bg-[#09e1f0]"></button>
              </div>
             {bg_color&& <div
                className="absolute w-[410px] bottom-[-70px] bg-base-200 p-5 left-0 drop-shadow-lg rounded-[10px] z-30"
              >
                <div className="flex justify-between items-center py-2">
                  <p className="text-[20px] font-[600]">Ranglar</p>
                </div>
                <div className="div-1 pt-2">
                  <button onClick={()=>{setBg_images()}} className="bg-[#000]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#f56c03]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#e6f603]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#50f404]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#02fff2]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#044aec]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#8604e8]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#e909b8]"></button>
                  <button onClick={()=>{setBg_images()}} className="bg-[#f50404]"></button>
                </div>
                <div className="border-b-[1px] border-[#f0f0f04b] py-2"></div>
                <div className="div-1 mt-4">
                  <button onClick={()=>{setBg_images("#f40370")}} className="bg-[#f40370]"></button>
                  <button onClick={()=>{setBg_images("#1f0630")}} className="bg-[#1f0630]"></button>
                  <button  onClick={()=>{setBg_images("#012632")}} className="bg-[#012632]"></button>
                  <button onClick={()=>{setBg_images("#25793e")}} className="bg-[#25793e]"></button>
                  <button onClick={()=>{setBg_images("#e0b414")}} className="bg-[#e0b414]"></button>
                  <button onClick={()=>{setBg_images("#17194d")}} className="bg-[#17194d]"></button>
                  <button onClick={()=>{setBg_images("#03ead6")}} className="bg-[#03ead6]"></button>
                  <button onClick={()=>{setBg_images("#07b8ed")}} className="bg-[#07b8ed]"></button>
                  <button onClick={()=>{setBg_images("#eb6906")}} className="bg-[#eb6906]"></button>
                </div>
              </div>}
            </div>
          </div>
